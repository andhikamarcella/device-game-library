                    ...
                    <div className="flex flex-wrap items-center gap-2 text-xs text-slate-600 dark:text-slate-300">
                      {uniquePlatforms.map((platform) => {
                        ...
                        return (
                          <div
                            key={platform.id}
                            className="inline-flex items-center gap-2 rounded-md border border-slate-300/70 bg-slate-950/5 px-3 py-1 text-slate-700 dark:border-slate-700/70 dark:bg-slate-800/70 dark:text-slate-200"
                          >
                            {Icon ? <Icon className="h-4 w-4 text-slate-600 dark:text-slate-100" /> : null}
                        ...
                        {additionPlatforms.map((platform) => {
                          ...
                          return (
                            <div
                              ...
                              className="inline-flex items-center gap-1 rounded-full bg-slate-800/60 px-2 py-0.5 text-[11px] text-slate-100"
                            >
                              {Icon ? <Icon className="h-3.5 w-3.5 text-slate-100" /> : null}
