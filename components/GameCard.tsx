            ...
            <div className="flex flex-wrap gap-2">
              {game.platforms.slice(0, 4).map((platform) => {
                ...
                return (
                  <div
                    key={platform.id}
                    className="inline-flex items-center gap-2 rounded-md border border-slate-200/70 bg-slate-900/5 px-2 py-1 text-xs font-medium text-slate-600 dark:border-slate-700/70 dark:bg-slate-800/70 dark:text-slate-200"
                  >
