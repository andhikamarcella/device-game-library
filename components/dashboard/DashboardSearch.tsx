  ...
  return (
    <section className="space-y-6">
      <form
        ...
        className="grid gap-6 rounded-3xl border border-slate-200 bg-white p-6 shadow-xl shadow-emerald-500/5 transition dark:border-slate-800 dark:bg-slate-900"
      >
        ...
        <div className="grid gap-3 md:grid-cols-3">
          <label className="flex flex-col">
            ...
            <input
              ...
              className="rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm transition focus:border-emerald-500 focus:outline-none focus:ring-2 focus:ring-emerald-400/60 dark:border-slate-700 dark:bg-slate-900"
              type="text"
            />
          </label>
          <label className="flex flex-col">
          ...
          <div className="flex flex-wrap items-center gap-3 text-sm text-slate-600 dark:text-slate-300">
            <div className="flex items-center gap-2">
              ...
              <input
                ...
                className="w-16 rounded border border-slate-200 px-2 py-1 text-center dark:border-slate-700 dark:bg-slate-900"
              />
          ...
          {results.map((result) => {
            ...
            return (
              <article
                ...
                className="flex flex-col gap-4 rounded-2xl border border-slate-200 bg-white p-4 shadow-lg shadow-emerald-500/5 transition hover:-translate-y-1 hover:shadow-emerald-500/20 dark:border-slate-800 dark:bg-slate-900"
              >
                <div className="flex items-start gap-3">
                  <div className="relative h-24 w-20 overflow-hidden rounded-xl border border-slate-200 bg-slate-200 dark:border-slate-800 dark:bg-slate-900">
                    {result.coverImage ? (
                      <div
                        aria-hidden
                ...
                {inLibrary && entry && (
                  <div className="space-y-3 rounded-xl border border-slate-200 bg-white p-3 text-sm transition dark:border-slate-800 dark:bg-slate-900">
                      ...
                      {personalNotesOpen && (
                        <div className="mt-2 space-y-2">
                          <textarea
                            ...
                            rows={3}
                            className="w-full rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm text-slate-700 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-200"
                          />
