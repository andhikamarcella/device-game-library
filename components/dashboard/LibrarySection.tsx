...
export function LibrarySection() {
  ...
  return (
    <section className="space-y-6">
      <header className="flex flex-wrap items-center justify-between gap-4">
        ...
        <div className="flex flex-wrap items-center gap-3 text-xs sm:text-sm">
          ...
          <select
            ...
            className="rounded-xl border border-slate-200 bg-white px-3 py-1 dark:border-slate-700 dark:bg-slate-900"
          >
          ...
          <label className="flex items-center gap-2">
            ...
            <input
              ...
              className="w-16 rounded border border-slate-200 px-2 py-1 text-center text-sm dark:border-slate-700 dark:bg-slate-900"
            />
          </label>
          <select
            value={sort}
      ...
      {sorted.length === 0 ? (
        <p className="rounded-2xl border border-slate-200 bg-white p-6 text-center text-sm text-slate-600 dark:border-slate-800 dark:bg-slate-900 dark:text-slate-300">
        ...
        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
          {sorted.map((entry) => (
            <article
              key={entry.rawgId}
              className="flex flex-col gap-3 rounded-2xl border border-slate-200 bg-white p-4 shadow-lg shadow-emerald-500/5 transition hover:-translate-y-1 hover:shadow-emerald-500/20 dark:border-slate-800 dark:bg-slate-900"
            >
