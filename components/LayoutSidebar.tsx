...
export function LayoutSidebar({ open, onClose }: { open: boolean; onClose: () => void }) {
  ...
  const SidebarContent = (
    <div className="flex h-full flex-col border-r border-slate-200/50 bg-white/70 text-slate-900 backdrop-blur transition-colors duration-300 dark:border-slate-800/60 dark:bg-[#081225]/85 dark:text-slate-100 high-contrast-surface">
      ...
      <div className="border-t border-slate-200/60 px-6 py-5 text-xs text-slate-500 transition-colors duration-300 dark:border-white/10 dark:text-slate-400">
