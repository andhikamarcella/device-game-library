      ...
      {notesOpen && (
        <div className="space-y-2">
          <textarea
            ...
            rows={4}
            className="w-full rounded-xl border border-slate-300/60 bg-white/80 px-3 py-2 text-sm text-slate-900 shadow-sm outline-none transition focus:border-emerald-500 focus:ring-2 focus:ring-emerald-400/60 dark:border-slate-700 dark:bg-slate-900/70 dark:text-slate-100"
          />
