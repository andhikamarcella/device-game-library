...
export const siAndroid = createIcon(
  "Android",
  "android",
  "3DDC84",
  "M8 4.2 6.9 3l-.8.8L7.4 5A4.4 4.4 0 0 0 5 9v7.5A1.5 1.5 0 0 0 6.5 18h.5v2h2v-2h6v2h2v-2h.5A1.5 1.5 0 0 0 19 16.5V9a4.4 4.4 0 0 0-2.4-4l1.3-1.8-.8-.8-1.2 1a5 5 0 0 0-6.8 0l-1.2-1-.8.8L8 4.2Zm1.5.8a3.5 3.5 0 0 1 5 0L13.6 7H10.4ZM9 9h6v5H9Zm-3 0h2v5H6Zm10 0h2v5h-2Z"
);

export const siNintendo = createIcon(
  "Nintendo",
  "nintendo",
  "E60012",
  "M5 6h14a3 3 0 0 1 3 3v6a3 3 0 0 1-3 3H5a3 3 0 0 1-3-3V9a3 3 0 0 1 3-3Zm0 2a1 1 0 0 0-1 1v6a1 1 0 0 0 1 1h14a1 1 0 0 0 1-1V9a1 1 0 0 0-1-1Z"
);

export const siIos = createIcon(
  "iOS",
  "ios",
  "A3AAAE",
  "M15.5 3c-.9 0-1.9.6-2.4 1.3-.5.6-.9 1.5-.8 2.3 1 .1 2-.5 2.6-1.2.5-.6.9-1.5.6-2.4Zm2.4 5.4c-1-.1-1.9.4-2.5.4-.7 0-1.7-.4-2.8-.4-2 0-4.2 1.2-5.2 3.3-1.8 3.3-.5 8.4 1.3 11 .9 1.3 2.1 2.8 3.6 2.7 1.4 0 1.9-.9 3.6-.9 1.7 0 2.1.9 3.6.9 1.5 0 2.5-1.3 3.4-2.6 1.1-1.5 1.5-3 1.5-3.1-.1 0-2.9-1.1-3-4.2-.1-2.6 2.1-3.8 2.2-3.9-1.2-1.7-3.1-1.9-3.7-2.1Z"
