...
export function resolveTgdbBoxArt(game: TgdbGame, baseUrl?: TgdbImageResponse): string | null {
  ...
  const prefix = baseUrl.original ?? baseUrl.thumb ?? "";
