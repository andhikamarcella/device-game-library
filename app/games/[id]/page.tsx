...
export default async function GameDetailPage({ params }: { params: { id: string } }) {
  ...
  return (
    <div className="space-y-12 pb-16">
      <div className="relative overflow-hidden rounded-3xl border border-slate-200/70 bg-white/80 shadow-xl shadow-emerald-500/10 dark:border-white/10 dark:bg-[#081a32]/85">
        {heroImage && (
        ...
        <div className="relative grid gap-10 p-8 md:grid-cols-[220px_1fr] md:p-12">
          <div className="flex flex-col items-start gap-4">
            <div className="overflow-hidden rounded-3xl border border-slate-200/60 bg-slate-900/60 shadow-2xl shadow-slate-950/40 dark:border-white/10 dark:bg-[#0f213d]/80">
              {coverImage ? (
                <div
                  aria-hidden
