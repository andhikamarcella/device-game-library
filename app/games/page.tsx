...
export default function GamesPage() {
  ...
  useEffect(() => {
    ...
    if (rawgPlatforms.length > 0 || rawgPlatformLoading) {
      return;
    }
  ...
  }, [isModalOpen, rawgPlatforms.length, rawgPlatformLoading]);
      ...
      >
        <div className="space-y-6">
          <section className="space-y-4 rounded-2xl border border-slate-200 bg-white/70 p-4 shadow-sm dark:border-slate-800 dark:bg-slate-900/60">
              ...
              <div className="space-y-2">
                ...
                >
                  ...
                  {rawgPlatformLoading ? (
                    ...
                    filteredRawgPlatforms.slice(0, 40).map((platform) => (
            ...
            {rawgPlatformError ? (
              <p className="text-xs text-rose-600 dark:text-rose-300">{rawgPlatformError}</p>
            ) : null}
            {rawgError ? (
