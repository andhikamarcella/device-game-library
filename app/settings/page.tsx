              ...
              <button
                ...
                className={cn(
                  ...
                  isActive
                    ...
                    : "border-slate-200 bg-white/85 text-slate-600 hover:-translate-y-0.5 hover:border-emerald-300 hover:text-emerald-700 dark:border-slate-800 dark:bg-slate-900 dark:text-slate-300",
                )}
                aria-pressed={isActive}
              >
