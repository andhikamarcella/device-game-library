...
function DeviceForm({
  ...
  const fieldClass =
    "w-full rounded-xl border border-slate-200 bg-white px-4 py-2 text-sm text-slate-900 shadow-sm focus:border-emerald-500 focus:ring-emerald-400 dark:border-slate-800 dark:bg-slate-900 dark:text-slate-100";
      ...
      <Card>
        <div className="flex flex-wrap items-center gap-3">
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm text-slate-900 shadow-sm focus:border-emerald-500 focus:ring-emerald-400 dark:border-slate-800 dark:bg-slate-900 dark:text-slate-100"
            >
          ...
          <div className="flex-1">
            <input
              ...
              className="w-full rounded-xl border border-slate-200 bg-white px-4 py-2 text-sm text-slate-900 shadow-sm focus:border-emerald-500 focus:ring-emerald-400 dark:border-slate-800 dark:bg-slate-900 dark:text-slate-100"
            />
          </div>
        </div>
        <div className="mt-6 overflow-hidden rounded-2xl border border-slate-200 shadow-sm shadow-slate-900/10 dark:border-slate-800">
          <div className="max-w-full overflow-x-auto">
            <table className="min-w-full divide-y divide-slate-200 dark:divide-slate-800" aria-label="Devices list">
            ...
            <tbody className="divide-y divide-slate-200 dark:divide-slate-800/70">
              {filteredDevices.length === 0 ? (
                ...
                filteredDevices.map((device) => {
                  ...
                  return (
                    <tr key={device.id} className="transition-colors hover:bg-emerald-500/5 dark:hover:bg-slate-900/60">
                      <td className="px-4 py-3">
                        <div className="flex items-center gap-2">
                          <button
                            ...
                            aria-label={device.favorite ? "Remove favorite" : "Mark as favorite"}
                            aria-pressed={device.favorite ?? false}
                          >
